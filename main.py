...
SSID = 'TOMTEWIFI'
WELCOME = 'God Jul onskar Huskvarna tomten !!! Tryck pa knappen for att fa ett kul skamt ..'
DEFAULT = (
    'När öppnar en småläning sin börs?'
    '................ Då någon vill lägga pengar i den!',
    'Varför ramlar de där ungarna hela tiden?'
    '................ De är ju trillingar!',
    'Vilket djur mår sämst?'
    '................ Moskiten.',
    'Var kan man köpa kor billigast i världen?'
    '................. Korea.',
    'Vad är klockan?'
    '................. En anordning som visar tiden.',
    'Vad är en groda utan ben?'
    '................. Hopplös.',
    'Vilket djur är coolast?'
    '................. Svalan.')
...
async def handler(r, w):
    ...
    # write page body
    w.write(b'<html><body>')
    w.write(b'Huskvarna tomtens berättelser<br/><br/><br/>')
    w.write(b'Aktuella historied inlagda:<br/>')
    for _ in read_texts():
        w.write(_.encode() + b'<br/>')
    w.write(b'<br/><br/>')
    w.write(FORM)
    w.write(b'<br/><a href="/rensa">Lägg in standard list</a>')
...
class Scroller():
    def __init__(self, display_controller=None, scl=pins['scl'], sda=pins['sda'], width=128, height=32):
